...
class ChuyenNganh extends Model
{
    ...
    public function check_ten_chuyen_nganh()
    {
        $check = DB::select("select count(ten_chuyen_nganh) as demTen from chuyen_nganh where ten_chuyen_nganh = '$this->ten_chuyen_nganh' ");
        return $check;
    }
}
