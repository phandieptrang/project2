...
<body>
	...
	<table border="1" width="100%">
		<caption>
			<button style="background: black;float: left;height: 30px">
				<a style="color: white;text-decoration: none;" href="{{route('mon.view_insert')}}">
					Thêm Môn
				</a>
			</button>
			<br><br>
		...
		<tr  style="background: lightgray">
			...
			<th style="width: 20%">Lương từng môn</th>
			<th style="width: 20%">Thời gian định mức</th>
			<th style="width: 5%"></th>
		</tr>
	</table>
</div>
<div style="height: 420px;width:90%;overflow: auto">
<table style="width: 100%">
		@foreach ($array_mon as $mon)
			<tr>
				<td style="width: 5%">{{$mon->ma_mon}}</td>
				<td style="width: 20%">{{$mon->ten_mon}}</td>
				<td style="width: 20%">{{$mon->ten_chuyen_nganh}}</td>
				<td style="width: 20%;text-align: center">{{$mon->luong_tung_mon}}</td>
				<td style="width: 20%;text-align: center;">{{$mon->thoi_gian_dinh_muc}}</td>
				<td style="width: 5%">
