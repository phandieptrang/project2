...
<body>
	...
	<div class="container">
		<div class="col-lg-4"  style="border-radius: 5px;border: 1px solid black;width: 55%;margin-top: 6%;margin-left: 23%;box-shadow: 10px 15px #F49E9ECD">
			...
			{{csrf_field()}}
				...
				<input type="hidden" name="ma_mon" value="{{$mon->ma_mon}}">
						@if($mon->ma_chuyen_nganh == 1)
							<br>Lập trình
						@elseif($mon->ma_chuyen_nganh == 2)
							<br>Quản trị mạng
						@else
							<br>Quản trị kinh doanh
						@endif
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<br>{{$mon->thoi_gian_dinh_muc}}
					</div>
				<div class="form-group">
					<label>Lương từng môn</label>
					<input name="luong_tung_mon" type="text" value="{{$mon->luong_tung_mon}}" pattern="[0-9]+" minlength="5" min=1 required="required"style="height: 34px;border-radius: 3px;width: 100%">
				</div>
				<div class="form-group">
