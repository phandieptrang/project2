				...
				<div class="form-group" id="div_mon">
					...
					@foreach($array_mon as $mon )
						@if($mon->ma_mon == $phan_cong->ma_mon)
							{{$mon->ten_mon}}<input type="hidden" name="ma_mon" value="{{$mon->ma_mon}}" required="required">
						@endif
					@endforeach
					</div>
				<div class="form-group">
					...
					@foreach($array_lop as $lop)
						@if($lop->ma_lop == $phan_cong->ma_lop)
							{{$lop->ten_lop}}<input type="hidden" name="ma_lop" value="{{$lop->ma_lop}}" required="required">
						@endif
					@endforeach
				</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="number" name="thoi_gian_dinh_muc_mon" value="{{$phan_cong->thoi_gian_dinh_muc_mon}}" required="required">
					</div>
